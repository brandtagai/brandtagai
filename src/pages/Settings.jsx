...
export default function BrandTagSettings() {
  ...
  // 500 FONTS - Alphabetically organized
  const fonts = [
    ...
    "Lucida Sans", "Monaco", "Monaco Mono", "Montserrat",
    "MS Gothic", "MS PGothic", "MS Sans Serif", "MS Serif",
    "New Century Schoolbook", "Optima", "Palatino", "Papyrus",
    "Perpetua", "Playfair Display", "Rockwell", "Sabon",
    "Segoe UI", "Tahoma", "Times", "Times New Roman",
    "Trebuchet MS", "Verdana", "Zapfino"
    // Note: In production, you'd have all 500 fonts loaded
  ];
