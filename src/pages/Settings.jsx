    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white pb-20">
      ...
      <div className="px-6 py-6 space-y-6">
          ...
          <Card className="border-white/20 bg-white/10 backdrop-blur-lg">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
                ...
                Brand Logo (Optional) {/* Updated title */}
              </CardTitle>
            </CardHeader>
                ...
                {settings.logo_url && (
                  <div className="relative">
                    <img
                      ...
                      alt="Logo preview"
                      className="w-16 h-16 object-contain rounded-lg border-2 border-white/20 bg-white/10"
                    />
                    <Button
                      variant="ghost"
                      size="icon"
        ...
        >
          <Card className="border-white/20 bg-white/10 backdrop-blur-lg">
            <CardHeader>
              <CardTitle className="text-white">Brand Text (Optional)</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                <Label htmlFor="brand-text" className="text-blue-200">Business Name / Website</Label>
                <Input
                  id="brand-text"
                ...
                />
                <p className="text-xs text-gray-400">This will appear next to your logo on images</p>
              </div>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="border-white/20 bg-white/10 backdrop-blur-lg">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-base font-medium text-white">Position</Label> {/* Updated label */}
                  <p className="text-sm text-blue-200">Choose bottom-left or bottom-right</p> {/* Updated description */}
                </div>
